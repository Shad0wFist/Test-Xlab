...
Properties { 
	...
	_BaseColor ("Base color", COLOR)  = ( .54, .95, .99, 1.0) 
...
Subshader
{
	Tags {"RenderType"="Opaque" "Queue"="Geometry"} // изменили RenderType и Queue
	
	Lod 500
	ColorMask RGB
	
	Pass {
			// Убрали строку с Blend
			// Blend SrcAlpha OneMinusSrcAlpha
			
			ZTest LEqual
			ZWrite On // включили запись в z-буфер
			Cull Off
			...
			// Убрали multi_compile для прозрачности
